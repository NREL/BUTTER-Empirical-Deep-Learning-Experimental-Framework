...
-- upgraded quartile summary update:
...
insert into experiment_summary_ (
    ...
    kullback_leibler_divergence_avg, kullback_leibler_divergence_stddev,
    kullback_leibler_divergence_q1, kullback_leibler_divergence_median, kullback_leibler_divergence_q3,
    val_loss_min_min_epoch, val_loss_min_max_epoch, val_loss_min_avg_epoch, val_loss_min_epoch_q1, val_loss_min_epoch_median, val_loss_min_epoch_q3, val_loss_min_min_value, val_loss_min_max_value, val_loss_min_avg_value, val_loss_min_value_q1, val_loss_min_value_median, val_loss_min_value_q3, val_accuracy_max_min_epoch, val_accuracy_max_max_epoch, val_accuracy_max_avg_epoch, val_accuracy_max_epoch_q1, val_accuracy_max_epoch_median, val_accuracy_max_epoch_q3, val_accuracy_max_min_value, val_accuracy_max_max_value, val_accuracy_max_avg_value, val_accuracy_max_value_q1, val_accuracy_max_value_median, val_accuracy_max_value_q3, val_mean_squared_error_min_min_epoch, val_mean_squared_error_min_max_epoch, val_mean_squared_error_min_avg_epoch, val_mean_squared_error_min_epoch_q1, val_mean_squared_error_min_epoch_median, val_mean_squared_error_min_epoch_q3, val_mean_squared_error_min_min_value, val_mean_squared_error_min_max_value, val_mean_squared_error_min_avg_value, val_mean_squared_error_min_value_q1, val_mean_squared_error_min_value_median, val_mean_squared_error_min_value_q3, val_kullback_leibler_divergence_min_min_epoch, val_kullback_leibler_divergence_min_max_epoch, val_kullback_leibler_divergence_min_avg_epoch, val_kullback_leibler_divergence_min_epoch_q1, val_kullback_leibler_divergence_min_epoch_median, val_kullback_leibler_divergence_min_epoch_q3, val_kullback_leibler_divergence_min_min_value, val_kullback_leibler_divergence_min_max_value, val_kullback_leibler_divergence_min_avg_value, val_kullback_leibler_divergence_min_value_q1, val_kullback_leibler_divergence_min_value_median, val_kullback_leibler_divergence_min_value_q3
)
select
    e.experiment_id,
    experiment_parameters,
...
lateral (
    ...
    select * from
        (
            ...
            (
                select
                    val_loss_min_min_epoch, val_loss_min_max_epoch, val_loss_min_avg_epoch, val_loss_min_epoch_percentile[1] val_loss_min_epoch_q1, val_loss_min_epoch_percentile[2] val_loss_min_epoch_median, val_loss_min_epoch_percentile[3] val_loss_min_epoch_q3, 
                    val_loss_min_min_value, val_loss_min_max_value, val_loss_min_avg_value, val_loss_min_value_percentile[1] val_loss_min_value_q1, val_loss_min_value_percentile[2] val_loss_min_value_median, val_loss_min_value_percentile[3] val_loss_min_value_q3
                from
                    (
                    select
                        min(epoch)::integer val_loss_min_min_epoch, max(epoch)::integer val_loss_min_max_epoch, avg(epoch)::real val_loss_min_avg_epoch, (PERCENTILE_CONT(array[.25, .5, .75]) WITHIN GROUP(ORDER BY coalesce(epoch, 'NaN'::real)))::real[] val_loss_min_epoch_percentile,
                        min(v)::real val_loss_min_min_value, max(v)::real val_loss_min_max_value, avg(v)::real val_loss_min_avg_value, (PERCENTILE_CONT(array[.25, .5, .75]) WITHIN GROUP(ORDER BY coalesce(v, 'NaN'::real)))::real[] val_loss_min_value_percentile
                    from
                        (
                        select
    ...
    lateral (
        ...
        select * from
            ...
            (
                select
                    val_accuracy_max_min_epoch, val_accuracy_max_max_epoch, val_accuracy_max_avg_epoch, val_accuracy_max_epoch_percentile[1] val_accuracy_max_epoch_q1, val_accuracy_max_epoch_percentile[2] val_accuracy_max_epoch_median, val_accuracy_max_epoch_percentile[3] val_accuracy_max_epoch_q3, 
                    val_accuracy_max_min_value, val_accuracy_max_max_value, val_accuracy_max_avg_value, val_accuracy_max_value_percentile[1] val_accuracy_max_value_q1, val_accuracy_max_value_percentile[2] val_accuracy_max_value_median, val_accuracy_max_value_percentile[3] val_accuracy_max_value_q3
                from
                    (
                    select
                        min(epoch)::integer val_accuracy_max_min_epoch, max(epoch)::integer val_accuracy_max_max_epoch, avg(epoch)::real val_accuracy_max_avg_epoch, (PERCENTILE_CONT(array[.25, .5, .75]) WITHIN GROUP(ORDER BY coalesce(epoch, 'NaN'::real)))::real[] val_accuracy_max_epoch_percentile,
                        min(v)::real val_accuracy_max_min_value, max(v)::real val_accuracy_max_max_value, avg(v)::real val_accuracy_max_avg_value, (PERCENTILE_CONT(array[.25, .5, .75]) WITHIN GROUP(ORDER BY coalesce(v, 'NaN'::real)))::real[] val_accuracy_max_value_percentile
                    from
                        (
                            select
                                distinct on (run_ctid) run_ctid, epoch, v
    ...
    lateral (
        ...
        select * from 
            ...
            (
                select
                    val_mean_squared_error_min_min_epoch, val_mean_squared_error_min_max_epoch, val_mean_squared_error_min_avg_epoch, val_mean_squared_error_min_epoch_percentile[1] val_mean_squared_error_min_epoch_q1, val_mean_squared_error_min_epoch_percentile[2] val_mean_squared_error_min_epoch_median, val_mean_squared_error_min_epoch_percentile[3] val_mean_squared_error_min_epoch_q3, 
                    val_mean_squared_error_min_min_value, val_mean_squared_error_min_max_value, val_mean_squared_error_min_avg_value, val_mean_squared_error_min_value_percentile[1] val_mean_squared_error_min_value_q1, val_mean_squared_error_min_value_percentile[2] val_mean_squared_error_min_value_median, val_mean_squared_error_min_value_percentile[3] val_mean_squared_error_min_value_q3
                from
                    (
                    select
                        min(epoch)::integer val_mean_squared_error_min_min_epoch, max(epoch)::integer val_mean_squared_error_min_max_epoch, avg(epoch)::real val_mean_squared_error_min_avg_epoch, (PERCENTILE_CONT(array[.25, .5, .75]) WITHIN GROUP(ORDER BY coalesce(epoch, 'NaN'::real)))::real[] val_mean_squared_error_min_epoch_percentile,
                        min(v)::real val_mean_squared_error_min_min_value, max(v)::real val_mean_squared_error_min_max_value, avg(v)::real val_mean_squared_error_min_avg_value, (PERCENTILE_CONT(array[.25, .5, .75]) WITHIN GROUP(ORDER BY coalesce(v, 'NaN'::real)))::real[] val_mean_squared_error_min_value_percentile
                    from
                        (
                            select
                                distinct on (run_ctid) run_ctid, epoch, v
...
--         relative_size_error = EXCLUDED.relative_size_error,
        ...
        kullback_leibler_divergence_avg = EXCLUDED.kullback_leibler_divergence_avg,kullback_leibler_divergence_stddev = EXCLUDED.kullback_leibler_divergence_stddev,
        kullback_leibler_divergence_q1 = EXCLUDED.kullback_leibler_divergence_q1,kullback_leibler_divergence_median = EXCLUDED.kullback_leibler_divergence_median,kullback_leibler_divergence_q3 = EXCLUDED.kullback_leibler_divergence_q3,
        val_loss_min_min_epoch = EXCLUDED.val_loss_min_min_epoch, val_loss_min_max_epoch = EXCLUDED.val_loss_min_max_epoch, val_loss_min_avg_epoch = EXCLUDED.val_loss_min_avg_epoch, val_loss_min_epoch_q1 = EXCLUDED.val_loss_min_epoch_q1, val_loss_min_epoch_median = EXCLUDED.val_loss_min_epoch_median, val_loss_min_epoch_q3 = EXCLUDED.val_loss_min_epoch_q3, val_loss_min_min_value = EXCLUDED.val_loss_min_min_value, val_loss_min_max_value = EXCLUDED.val_loss_min_max_value, val_loss_min_avg_value = EXCLUDED.val_loss_min_avg_value, val_loss_min_value_q1 = EXCLUDED.val_loss_min_value_q1, val_loss_min_value_median = EXCLUDED.val_loss_min_value_median, val_loss_min_value_q3 = EXCLUDED.val_loss_min_value_q3, val_accuracy_max_min_epoch = EXCLUDED.val_accuracy_max_min_epoch, val_accuracy_max_max_epoch = EXCLUDED.val_accuracy_max_max_epoch, val_accuracy_max_avg_epoch = EXCLUDED.val_accuracy_max_avg_epoch, val_accuracy_max_epoch_q1 = EXCLUDED.val_accuracy_max_epoch_q1, val_accuracy_max_epoch_median = EXCLUDED.val_accuracy_max_epoch_median, val_accuracy_max_epoch_q3 = EXCLUDED.val_accuracy_max_epoch_q3, val_accuracy_max_min_value = EXCLUDED.val_accuracy_max_min_value, val_accuracy_max_max_value = EXCLUDED.val_accuracy_max_max_value, val_accuracy_max_avg_value = EXCLUDED.val_accuracy_max_avg_value, val_accuracy_max_value_q1 = EXCLUDED.val_accuracy_max_value_q1, val_accuracy_max_value_median = EXCLUDED.val_accuracy_max_value_median, val_accuracy_max_value_q3 = EXCLUDED.val_accuracy_max_value_q3, val_mean_squared_error_min_min_epoch = EXCLUDED.val_mean_squared_error_min_min_epoch, val_mean_squared_error_min_max_epoch = EXCLUDED.val_mean_squared_error_min_max_epoch, val_mean_squared_error_min_avg_epoch = EXCLUDED.val_mean_squared_error_min_avg_epoch, val_mean_squared_error_min_epoch_q1 = EXCLUDED.val_mean_squared_error_min_epoch_q1, val_mean_squared_error_min_epoch_median = EXCLUDED.val_mean_squared_error_min_epoch_median, val_mean_squared_error_min_epoch_q3 = EXCLUDED.val_mean_squared_error_min_epoch_q3, val_mean_squared_error_min_min_value = EXCLUDED.val_mean_squared_error_min_min_value, val_mean_squared_error_min_max_value = EXCLUDED.val_mean_squared_error_min_max_value, val_mean_squared_error_min_avg_value = EXCLUDED.val_mean_squared_error_min_avg_value, val_mean_squared_error_min_value_q1 = EXCLUDED.val_mean_squared_error_min_value_q1, val_mean_squared_error_min_value_median = EXCLUDED.val_mean_squared_error_min_value_median, val_mean_squared_error_min_value_q3 = EXCLUDED.val_mean_squared_error_min_value_q3, val_kullback_leibler_divergence_min_min_epoch = EXCLUDED.val_kullback_leibler_divergence_min_min_epoch, val_kullback_leibler_divergence_min_max_epoch = EXCLUDED.val_kullback_leibler_divergence_min_max_epoch, val_kullback_leibler_divergence_min_avg_epoch = EXCLUDED.val_kullback_leibler_divergence_min_avg_epoch, val_kullback_leibler_divergence_min_epoch_q1 = EXCLUDED.val_kullback_leibler_divergence_min_epoch_q1, val_kullback_leibler_divergence_min_epoch_median = EXCLUDED.val_kullback_leibler_divergence_min_epoch_median, val_kullback_leibler_divergence_min_epoch_q3 = EXCLUDED.val_kullback_leibler_divergence_min_epoch_q3, val_kullback_leibler_divergence_min_min_value = EXCLUDED.val_kullback_leibler_divergence_min_min_value, val_kullback_leibler_divergence_min_max_value = EXCLUDED.val_kullback_leibler_divergence_min_max_value, val_kullback_leibler_divergence_min_avg_value = EXCLUDED.val_kullback_leibler_divergence_min_avg_value, val_kullback_leibler_divergence_min_value_q1 = EXCLUDED.val_kullback_leibler_divergence_min_value_q1, val_kullback_leibler_divergence_min_value_median = EXCLUDED.val_kullback_leibler_divergence_min_value_median, val_kullback_leibler_divergence_min_value_q3 = EXCLUDED.val_kullback_leibler_divergence_min_value_q3
;
