...
from typing import Mapping, Iterator, Union
...
class Demarshaler(CommonMarshaler):
    ...
    def _(self, source: list):
        return Demarshaler.demarshal_typed(
            ...
            source,
            lambda d, s: [],
            lambda d, s: d.extend((d.demarshal(e) for e in s))
        )
    ...
    def demarshal_typed(
        ...
        self._register_label(dest)
        initialized_dest = initializer(self, source, dest)
        return dest if initialized_dest is None else initialized_dest
    ...
    @staticmethod
    def initialize_type_map(type_map: {TypeCode: ObjectDemarshaler}) -> None:
        pass
