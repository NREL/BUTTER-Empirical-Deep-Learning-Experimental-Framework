...
def main():
    ...
    data_columns = [
        ...
        pyarrow.field("test_loss_min_epoch_min", pyarrow.uint32(), nullable=True),
        pyarrow.field("test_loss_min_epoch_max", pyarrow.uint32(), nullable=True),
        pyarrow.field("test_loss_min_epoch_avg", pyarrow.float32(), nullable=True),
        pyarrow.field("test_loss_min_epoch_q1", pyarrow.float32(), nullable=True),
        pyarrow.field("test_loss_min_epoch_median", pyarrow.float32(), nullable=True),
        pyarrow.field("test_loss_min_epoch_q3", pyarrow.float32(), nullable=True),
        pyarrow.field("test_loss_min_value_min", pyarrow.float32(), nullable=True),
        pyarrow.field("test_loss_min_value_max", pyarrow.float32(), nullable=True),
        pyarrow.field("test_loss_min_value_avg", pyarrow.float32(), nullable=True),
        pyarrow.field("test_loss_min_value_q1", pyarrow.float32(), nullable=True),
        pyarrow.field("test_loss_min_value_median", pyarrow.float32(), nullable=True),
        pyarrow.field("test_loss_min_value_q3", pyarrow.float32(), nullable=True),
        pyarrow.field("test_accuracy_max_epoch_min", pyarrow.uint32(), nullable=True),
        pyarrow.field("test_accuracy_max_epoch_max", pyarrow.uint32(), nullable=True),
        pyarrow.field("test_accuracy_max_epoch_avg", pyarrow.float32(), nullable=True),
        pyarrow.field("test_accuracy_max_epoch_q1", pyarrow.float32(), nullable=True),
        pyarrow.field(
            "test_accuracy_max_epoch_median", pyarrow.float32(), nullable=True
        ),
        pyarrow.field("test_accuracy_max_epoch_q3", pyarrow.float32(), nullable=True),
        pyarrow.field("test_accuracy_max_value_min", pyarrow.float32(), nullable=True),
        pyarrow.field("test_accuracy_max_value_max", pyarrow.float32(), nullable=True),
        pyarrow.field("test_accuracy_max_value_avg", pyarrow.float32(), nullable=True),
        pyarrow.field("test_accuracy_max_value_q1", pyarrow.float32(), nullable=True),
        pyarrow.field(
            "test_accuracy_max_value_median", pyarrow.float32(), nullable=True
        ),
        pyarrow.field("test_accuracy_max_value_q3", pyarrow.float32(), nullable=True),
        pyarrow.field(
            "test_mean_squared_error_min_epoch_min", pyarrow.uint32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_epoch_max", pyarrow.uint32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_epoch_avg", pyarrow.float32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_epoch_q1", pyarrow.float32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_epoch_median", pyarrow.float32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_epoch_q3", pyarrow.float32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_value_min", pyarrow.float32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_value_max", pyarrow.float32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_value_avg", pyarrow.float32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_value_q1", pyarrow.float32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_value_median", pyarrow.float32(), nullable=True
        ),
        pyarrow.field(
            "test_mean_squared_error_min_value_q3", pyarrow.float32(), nullable=True
        ),
        pyarrow.field(
            "test_kullback_leibler_divergence_min_epoch_min",
            pyarrow.uint32(),
            nullable=True,
        ),
        pyarrow.field(
            "test_kullback_leibler_divergence_min_epoch_max",
            pyarrow.uint32(),
            nullable=True,
        ),
        pyarrow.field(
            "test_kullback_leibler_divergence_min_epoch_avg",
            pyarrow.float32(),
            nullable=True,
        ),
        pyarrow.field(
            "test_kullback_leibler_divergence_min_epoch_q1",
            pyarrow.float32(),
            nullable=True,
        ),
        pyarrow.field(
            "test_kullback_leibler_divergence_min_epoch_median",
            pyarrow.float32(),
            nullable=True,
        ),
        pyarrow.field(
        ...
        pyarrow.field(
            "test_kullback_leibler_divergence_min_value_min",
            pyarrow.float32(),
            nullable=True,
        ),
        pyarrow.field(
            "test_kullback_leibler_divergence_min_value_max",
            pyarrow.float32(),
            nullable=True,
        ),
        pyarrow.field(
            "test_kullback_leibler_divergence_min_value_avg",
            pyarrow.float32(),
            nullable=True,
        ),
        pyarrow.field(
    ...
    if not simple:
        data_columns += [
            ...
            pyarrow.field("train_accuracy_q3", pyarrow.list_(pyarrow.float32())),
            pyarrow.field(
                "test_mean_squared_error_avg", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "test_mean_squared_error_stddev", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "test_mean_squared_error_median", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "test_mean_squared_error_q1", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "test_mean_squared_error_q3", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "train_mean_squared_error_avg", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "train_mean_squared_error_stddev", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "train_mean_squared_error_median", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "train_mean_squared_error_q1", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "train_mean_squared_error_q3", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "test_kullback_leibler_divergence_avg", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
            ...
            pyarrow.field(
                "test_kullback_leibler_divergence_median",
                pyarrow.list_(pyarrow.float32()),
            ),
            pyarrow.field(
                "test_kullback_leibler_divergence_q1", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "test_kullback_leibler_divergence_q3", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
            ...
            pyarrow.field(
                "train_kullback_leibler_divergence_median",
                pyarrow.list_(pyarrow.float32()),
            ),
            pyarrow.field(
                "train_kullback_leibler_divergence_q1", pyarrow.list_(pyarrow.float32())
            ),
            pyarrow.field(
                "train_kullback_leibler_divergence_q3", pyarrow.list_(pyarrow.float32())
            ),
        ]
    ...
    parquet.write_metadata(schema, dataset_path + "_common_metadata")
    ...
    with CursorManager(credentials) as cursor:
        ...
        q += sql.SQL(" ").join(
            [
                sql.SQL(
                    " left join parameter_ {} on ({}.kind = {} and s.experiment_parameters @> array[{}.id]) "
                ).format(
                    sql.Identifier(p),
                    sql.Identifier(p),
                    sql.Literal(p),
        ...
        if len(fixed_parameters) > 0:
            ...
            q += sql.SQL(" s.experiment_parameters @> array[{}]::smallint[] ").format(
                sql.SQL(" , ").join(
                    [
                        sql.Literal(p)
                        for p in parameter_map.to_parameter_ids(fixed_parameters)
                    ]
                )
            )
    ...
    def download_chunk(chunk):
        while True:
            try:
                ...
                q += sql.SQL(", ").join(
                    [
                        sql.Identifier(inverse_column_name_mapping.get(c, c))
                ...
                with CursorManager(
                    credentials, name=str(uuid.uuid1()), autocommit=False
                ) as cursor:
                    cursor.itersize = 8
                    ...
                    for row in cursor:
                        ...
                        for i in range(len(data_column_names)):
                            result_block[data_column_names[i]][row_number] = row[i + 1]
