...
def main():
    default_config = {
        ...
        "sweep_values": {
            ...
            ],  # ['rectangle', 'trapezoid', 'exponential', 'rectangle_residual', 'wide_first_2x', 'wide_first_4x', 'wide_first_8x', 'wide_first_16x', ],
            "size": [
                32,
                64,
                128,
    ...
    tasks = sorted(tasks, key=lambda t: (t.dataset, t.shape, t.depth, t.size, t.seed))
