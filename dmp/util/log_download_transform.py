...
rename_map.update({
    ...
    [
        ...
        'config.optimizer.config.learning_rate', 'config.optimizer.class_name',
...
'dataset' : 'str',
'topology' : 'str',
'optimizer.config.learning_rate' : 'float32',
'optimizer.class_name' : 'str',
'activation' : 'str',
'run_config.epochs' : 'int32',
'run_config.batch_size' : 'int32',
'run_config.validation_split' :'float32',
# 'label_noise' : 'float32',
'residual_mode' : 'str',
# 'loss' : 'float32[]',
# 'hinge' : 'float32[]',
...
def func():
    ...
    def read_chunk(read_number):
        ...
        ORDER BY id ASC
        LIMIT {read_size} OFFSET {read_size * read_number}
        '''
        ...
        for chunk in data_generator:
            ...
            print(f'Read #{read_number}: processing chunk size {num_entries} from database...')
