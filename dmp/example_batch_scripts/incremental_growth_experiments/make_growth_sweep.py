...
def main():
    default_config = {
        ...
        'sweep_values': {
            ...
            'growth_trigger_params': [{'patience':1}, {'patience':10}, {'patience':50}, {'patience':100}, {'patience':200}],
            ...
            'max_equivalent_epoch_budget':[3000] # epochs of training at the max size that will determine our parameter_epoch budget
        },
    }
