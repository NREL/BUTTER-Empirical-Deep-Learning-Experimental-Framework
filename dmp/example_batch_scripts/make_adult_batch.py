...
def main():
    default_config = {
        ...
        'sweep_values': {
            'batch': ['fixed_3k_1'],
            'dataset': ['adult', 'nursery',],# 'poker', 'splice', '294_satellite_image', 'banana', '505_tecator'],
            'input_activation': ['relu'],
            'activation': ['relu'],
            'optimizer': [{'class_name': 'adam', 'config': {'learning_rate': 0.0001}}],
            'shape': ['rectangle', 'trapezoid', 'exponential','wide_first_2x'], #'rectangle_residual', 'wide_first_2x', 'wide_first_4x', 'wide_first_8x', 'wide_first_16x', 'wide_first_2x_residual', 'wide_first_4x_residual', 'wide_first_8x_residual', 'wide_first_16x_residual'],
