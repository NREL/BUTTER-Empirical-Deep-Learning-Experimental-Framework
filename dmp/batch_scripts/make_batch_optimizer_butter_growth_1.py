...
def main():
    ...
    def make_experiment(
        ...
        return GrowthExperiment(
            ...
            run_tags={},
            batch='optimizer_butter_growth_1',
            precision='float32',
            dataset=DatasetSpec(
                dataset,
                'pmlb',
    ...
    sweep_config = list({
        # 'dataset': ['mnist'],
        'dataset': ['201_pol', '529_pollen', '537_houses',  'connect_4', 'sleep', 'wine_quality_white', 'adult', 'nursery', 'splice', '294_satellite_image', 'banana', '505_tecator', 'poker'],
