    ...
    default_config = {
        ...
        "sweep_values": {
            ...
            "dataset": [
                "adult",
                "nursery",
            ],  # 'poker', 'splice', '294_satellite_image', 'banana', '505_tecator'],
            ...
            "shape": [
                ...
                "exponential",
                "wide_first_2x",
            ],  #'rectangle_residual', 'wide_first_2x', 'wide_first_4x', 'wide_first_8x', 'wide_first_16x', 'wide_first_2x_residual', 'wide_first_4x_residual', 'wide_first_8x_residual', 'wide_first_16x_residual'],
            "size": [
                32,
                64,
                128,
