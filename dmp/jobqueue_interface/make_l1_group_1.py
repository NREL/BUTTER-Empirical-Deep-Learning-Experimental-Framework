    ...
    def do_sweep(key_index):
        ...
        if key_index < 0:
            for rep in range(repetitions):
                ...
                regularization_per_parameter = task_config['regularization_per_parameter']

                regularization_strength = regularization_per_parameter / \
                    task_config['size']
                task_config['kernel_regularizer'] = {
                    'type': 'l2', 'l2': regularization_strength}

                tc2 = deepcopy(task_config)
                del tc2['regularization_per_parameter']
...
def main():
    default_config = {
        ...
        'sweep_values': {
            ...
            # 51.2, 102.4, 204.8, 409.6, 819.2, 1638.4, 3276.8,]
            'regularization_per_parameter': [0.05, 0.1, 0.2, 0.4, 0.8, 1.6, 3.2, 6.4, 12.8, 25.6, ]
        },
    }
