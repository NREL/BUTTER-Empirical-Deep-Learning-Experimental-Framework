...
def main():
    default_config = {
        ...
        'sweep_values': {
            ...
            'shape': ['rectangle', 'trapezoid', 'exponential', 'wide_first_2x', 'wide_first_4x', 'wide_first_8x', 'wide_first_16x', 'rectangle_residual'],
            'size': [33554432, 67108864, 134217728],
