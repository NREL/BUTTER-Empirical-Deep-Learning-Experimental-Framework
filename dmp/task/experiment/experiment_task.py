...
from dmp.task.experiment.a_experiment_task import AExperimentTask, ParameterDict, ParameterValue
...
class ExperimentTask(AExperimentTask):
    ...
    run_tags: Optional[Dict[str, ParameterValue]] # extra tags related to this run of this experiment
