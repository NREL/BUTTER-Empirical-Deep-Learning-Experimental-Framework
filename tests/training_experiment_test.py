...
a = [1.0, 2.1, 3.3, -1.0, numpy.nan, None, 0, 1]
b = [1.0, 2.1, 3.3, -1.0, None, None, 0, 1]
c = [1.0, 2.1, 3.3, -1.0, numpy.nan, numpy.nan, 0, 1]
d = [1.0, 2.1, 3.3, -1.0, numpy.nan, None, 0.0, 1.0]
...
print(p)
print([(c, p[c].dtype, p[c].to_numpy().dtype) for c in p.columns])
